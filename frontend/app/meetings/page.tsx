...
const STEPS = [
  { name: 'Parsing meeting request', output: 'Meeting type, duration, attendees, and notes parsed by agent' },
  { name: 'Checking attendee calendars', output: 'Google Calendar freebusy API queried for all attendee emails' },
  { name: 'Finding available slots', output: 'Mutual availability windows identified across business hours' },
  { name: 'Selecting optimal time', output: 'LLM selected best slot from available windows based on context' },
  { name: 'Generating meeting agenda', output: 'Agenda items generated by LLM for meeting type and CRM context' },
  { name: 'Creating prep materials', output: 'Talking points, success criteria, and collateral assembled by agent' },
  { name: 'Setting reminders', output: 'Email reminder: 24h before · Popup reminder: 30 min before event' },
];
