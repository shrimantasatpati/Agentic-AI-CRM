...
const STEPS = [
  { name: 'Loading deal data', output: 'Deal record retrieved from CRM database' },
  { name: 'Calculating health score', output: 'LLM computed health score from deal signals and activity' },
  { name: 'Predicting close probability', output: 'Close probability predicted based on stage and engagement' },
  { name: 'Checking for stall conditions', output: 'Days since last activity checked against threshold' },
  { name: 'Identifying risk factors', output: 'Risk factors identified from deal timeline and engagement data' },
  { name: 'Generating recommendations', output: 'Action items generated by LLM for deal recovery' },
  { name: 'Forecasting close date', output: 'Projected close date estimated from pipeline velocity' },
];
